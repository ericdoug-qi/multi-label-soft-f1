...
flags.DEFINE_string(
    'model_dir', default='/Users/ericdoug/Documents/models/efficientnet-b4',
...
flags.DEFINE_integer(
    'num_train_images', default=29561, help='Size of training data set.')

flags.DEFINE_integer(
    'num_eval_images', default=7391, help='Size of evaluation data set.')
