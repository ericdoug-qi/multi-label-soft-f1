...
def define_flags():
  ...
  flags.DEFINE_string('dataset_cfg', 'moviesft', 'dataset config name.')
  ...
  flags.DEFINE_string('model_dir', '/Users/ericdoug/Documents/models/efficientnetv2-s-21k', 'Dir for checkpoint and summaries.')
