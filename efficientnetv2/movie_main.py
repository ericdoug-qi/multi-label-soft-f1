...
flags.DEFINE_bool('use_tpu', False, 'If true, use TPU; otherwise use CPU/GPU.')
...
flags.DEFINE_string('data_dir', '../data', 'The directory for training images.')
flags.DEFINE_string('eval_name', None, 'Evaluation name.')
flags.DEFINE_bool('archive_ckpt', True, 'If true, archive the best ckpt.')
flags.DEFINE_string('model_dir', '/Users/ericdoug/Documents/models/efficientnetv2-s-21k',
                    'Dir for checkpoint and summaries.')
...
def main(unused_argv):
    ...
    dataset_eval = datasets.build_dataset_input(False,
                                                input_image_size,
                                                image_dtype,
                                                FLAGS.data_dir,
                                                eval_split,
    ...
    if FLAGS.mode == 'eval':
        ...
        if FLAGS.mode == 'train':
            ...
            if not config.train.stages:
                dataset_train = datasets.build_dataset_input(True,
                                                             input_image_size,
                                                             image_dtype,
                                                             FLAGS.data_dir,
                                                             train_split,
